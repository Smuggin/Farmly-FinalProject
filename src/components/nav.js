        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
              <Image
                alt="Your Company"
                src="/dist/FarmlyNeighbor_logo_prototype 2.png"
                width={32}
                height={32}
                className="h-8 w-auto"
              />
            </div>
            <div className="hidden sm:block leading-none max-w-md ml-4 font-bold text-xl">Farmly<br/>Neighbor</div>
            <div className="hidden sm:block sm:ml-6 max-w-md w-full">
              <input
                  ...
                  className="h-full outline-2 outline-offset-2 w-full rounded-md bg-white/5 px-4 py-2 text-base border border-gray-300 placeholder:text-gray-500 focus:border-green-500 focus:outline-green-500 sm:text-sm/6"
                />
            </div>
            <div className="hidden sm:ml-2 sm:block">
              <button className='gap-1 btn btn-outline border-gray-300 focus:border-green-500 focus:outline-green-500 outline-2 outline-offset-2 text-base sm:text-sm/6 text-gray-500 font-medium'>
